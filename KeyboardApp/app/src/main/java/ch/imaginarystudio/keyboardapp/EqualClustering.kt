...
object Settings{
    const val tolerance = 0.00000000000000000000001
}


// Point is actually a 2Vec
data class Point(val x: Double, val y: Double) {
    operator fun times(t: Double): Point = Point(t * x, t * y)
...
data class Polygon(var corners : MutableList<Point> = mutableListOf()) {
    fun shiftCornersTowardsPoint(factor:Double, center:Point) {
